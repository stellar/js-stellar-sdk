/**
 * Type declarations for js-xdr-v4 (the legacy @stellar/js-xdr v4)
 * This file provides type definitions for the js-xdr-v4 (the legacy @stellar/js-xdr v4) library
