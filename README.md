...
Modern React Native uses Metro with autolinking, so no manual native linking or
custom resolver config is required — installing the packages above is enough.
