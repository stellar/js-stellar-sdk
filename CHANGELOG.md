...
### Changed
* `HorizonApi.Predicate` now aliases `HorizonPredicateJson`, adding the `unconditional` and `abs_before_epoch` fields it previously omitted. Non-breaking ([#1701](https://github.com/stellar/js-stellar-sdk/pull/1701)).
