...
// URLs and paths
const SAC_REPO_HASH = "5091827ad0e491f3cd3d3d70b9d4ce4ff52c200d";
const SAC_REPO_URL = `https://raw.githubusercontent.com/stellar/stellar-asset-contract-spec/${SAC_REPO_HASH}/stellar-asset-spec.xdr`;
...
https
  .get(SAC_REPO_URL, (response) => {
    ...
    response.on("end", () => {
      ...
      const tsContent = [
        "// Auto-generated by scripts/download-sac-spec.js",
        `// Commit hash: ${SAC_REPO_HASH}`,
