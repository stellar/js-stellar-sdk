...
describe("AssembledTransaction Tests", function () {
  let spec;
  let serverUrl = "https://your-soroban-server.url"; // Replace with actual server URL
  ...
  describe("buildFootprintRestoreTransaction", function () {
    ...
    beforeEach(function () {
      ...
      this.axiosMock = sinon.mock(StellarSdk.rpc.AxiosClient);
    });
